...
extern uint8_t i2c_write_reg(uint8_t devaddr, uint8_t regaddr, uint8_t* data, uint16_t length);
extern uint8_t i2c_read_reg(uint8_t devaddr, uint8_t regaddr, uint8_t* data, uint16_t length);
